...
| <a name="input_sns_topic_arn"></a> [sns\_topic\_arn](#input\_sns\_topic\_arn) | SNS Topic for notification , this mandatory if notifications\_enabled is false | `string` | `null` | no |
